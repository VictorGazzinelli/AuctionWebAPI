...
namespace AuctionWebAPI.Middleware
{
    public class AuctionMiddleware
    {
            ...
            return errorApp =>
            {
                errorApp.Run(async context =>
                {
                    ...
                    if (exceptionHandler != null)
                    {
                        ...
                        byte[] responseBody = Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(new ErrorMessage { Message = exception.Message }));
